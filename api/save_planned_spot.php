...
try {
    ...
    if (!$existingSpot) {
        $stmtInsertSpot = $pdo->prepare("INSERT INTO spots (name, category, lat, lng, stars, season, difficulty, water, visited_count, created_by) VALUES (:spot, 'Custom Spot', :lat, :lng, 5, 'All Year', 'Easy', 'Clear', 1, :uid)");
