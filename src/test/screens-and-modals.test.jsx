...
describe('React Screens & Modals Full Test Suite', () => {
  ...
  // ── 1. HomeScreen ──
  it('HomeScreen - Renders weather greeting hero card and feed tabs', async () => {
    await act(async () => {
  ...
  // ── 2. PassportScreen ──
  it('PassportScreen - Renders passport stats and paddle stamps grid', async () => {
    await act(async () => {
  ...
  // ── 3. GearLockerScreen ──
  it('GearLockerScreen - Renders gear items locker and add gear button', async () => {
    await act(async () => {
  ...
  it('AdminDashboardScreen - Renders super admin panel metrics and user status tags', async () => {
    await act(async () => {
  ...
  // ── 5. StatisticsScreen ──
  it('StatisticsScreen - Renders total paddle distance & monthly charts', async () => {
    await act(async () => {
  ...
  // ── 6. SpotDetailModal ──
  it('SpotDetailModal - Renders spot info and flyTo route action buttons', async () => {
  ...
  // ── 7. SafetyCheckModal ──
  it('SafetyCheckModal - Renders safety checklist items before paddling', async () => {
    const handleClose = vi.fn();
    await act(async () => {
  ...
  // ── 8. GearDetailModal ──
  it('GearDetailModal - Renders gear item specifications', async () => {
  ...
  // ── 9. EditProfileModal ──
  it('EditProfileModal - Renders profile editing fields', async () => {
    const handleClose = vi.fn();
    await act(async () => {
