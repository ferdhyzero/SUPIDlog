...
export default function PassportScreen({ userId = null, onRequireLogin, onTestStamp, refreshTrigger }) {
  ...
  return (
    <div style={{ width: '100%', padding: '12px 14px 20px 14px', display: 'flex', flexDirection: 'column', gap: '14px', boxSizing: 'border-box' }}>
      ...
      {/* Passport Hero Banner (Full Width Matching Header & Navigation) */}
      <div 
        style={{
          width: '100%',
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
          <div>
            <span style={{ fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.12em', opacity: 0.85, fontWeight: 800 }}>
              OFFICIAL DIGITAL PASSPORT
            </span>
            <h2 style={{ fontSize: '1.7rem', fontWeight: 900, display: 'flex', alignItems: 'center', gap: '8px', margin: '2px 0 0', fontFamily: 'var(--font-heading)' }}>
              MY PASSPORT
            </h2>
          </div>
          <div style={{ background: 'rgba(255,255,255,0.15)', padding: '10px', borderRadius: '14px', backdropFilter: 'blur(8px)' }}>
        ...
        {/* 3-Stat Metrics Grid: Visited, Target Pinned, Progress */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px', marginBottom: '16px' }}>
          <div style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(8px)', padding: '10px 6px', borderRadius: '14px', border: '1px solid rgba(255,255,255,0.2)', textAlign: 'center' }}>
            <span style={{ fontSize: '0.65rem', opacity: 0.85, fontWeight: 800, display: 'block' }}>Dikunjungi</span>
            <strong style={{ fontSize: '1.2rem', fontFamily: 'var(--font-heading)', fontWeight: 900 }}>{visitedCount} Spot</strong>
          </div>

          <div style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(8px)', padding: '10px 6px', borderRadius: '14px', border: '1px solid rgba(255,255,255,0.2)', textAlign: 'center' }}>
            <span style={{ fontSize: '0.65rem', opacity: 0.85, fontWeight: 800, display: 'block', color: '#FCD34D' }}>Target Pinned</span>
            <strong style={{ fontSize: '1.2rem', fontFamily: 'var(--font-heading)', fontWeight: 900, color: '#FBBF24' }}>{targetCount} Trip</strong>
          </div>

          <div style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(8px)', padding: '10px 6px', borderRadius: '14px', border: '1px solid rgba(255,255,255,0.2)', textAlign: 'center' }}>
            <span style={{ fontSize: '0.65rem', opacity: 0.85, fontWeight: 800, display: 'block' }}>Capaian SUP</span>
            <strong style={{ fontSize: '1.2rem', fontFamily: 'var(--font-heading)', fontWeight: 900, color: '#90E0EF' }}>{completedPercent}%</strong>
          </div>
        </div>
        ...
        {!isGuest && (
          <button
            ...
            style={{ width: '100%', background: 'rgba(255,255,255,0.25)', color: 'white', border: '1px solid rgba(255,255,255,0.4)', padding: '10px', borderRadius: '12px', fontWeight: 800, fontSize: '0.82rem', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}
          >
