    ...
    <div style={{ width: '100%', padding: '12px 12px 24px 12px', display: 'flex', flexDirection: 'column', gap: '12px', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'flex', background: '#E2E8F0', padding: '3px', borderRadius: '10px', gap: '2px' }}>
        ...
        <button
          ...
          style={{ flex: 1.2, padding: '6px 4px', borderRadius: '8px', border: 'none', fontWeight: 800, fontSize: '0.75rem', background: activeTab === 'ai_diagnostics' ? '#0284C7' : 'transparent', color: activeTab === 'ai_diagnostics' ? 'white' : '#64748B', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4px' }}
        >
